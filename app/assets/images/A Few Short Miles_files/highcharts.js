...
<div id="container">
  <h2>No route matches [GET] &quot;/javascripts/path/to/highcharts.js&quot;</h2>

  
<p><code>Rails.root: /Users/kevinrussell/wdi-dev/wdi-final</code></p>
...
<div id="traces">
    ...
    <div id="Framework-Trace" style="display: none;">
      <pre><code><a class="trace-frames" data-frame-id="0" href="#">actionpack (5.0.0.1) lib/action_dispatch/middleware/debug_exceptions.rb:53:in `call&#39;</a><br><a class="trace-frames" data-frame-id="1" href="#">web-console (3.3.1) lib/web_console/middleware.rb:131:in `call_app&#39;</a><br><a class="trace-frames" data-frame-id="2" href="#">web-console (3.3.1) lib/web_console/middleware.rb:28:in `block in call&#39;</a><br><a class="trace-frames" data-frame-id="3" href="#">web-console (3.3.1) lib/web_console/middleware.rb:18:in `catch&#39;</a><br><a class="trace-frames" data-frame-id="4" href="#">web-console (3.3.1) lib/web_console/middleware.rb:18:in `call&#39;</a><br><a class="trace-frames" data-frame-id="5" href="#">actionpack (5.0.0.1) lib/action_dispatch/middleware/show_exceptions.rb:31:in `call&#39;</a><br><a class="trace-frames" data-frame-id="6" href="#">railties (5.0.0.1) lib/rails/rack/logger.rb:36:in `call_app&#39;</a><br><a class="trace-frames" data-frame-id="7" href="#">railties (5.0.0.1) lib/rails/rack/logger.rb:24:in `block in call&#39;</a><br><a class="trace-frames" data-frame-id="8" href="#">activesupport (5.0.0.1) lib/active_support/tagged_logging.rb:70:in `block in tagged&#39;</a><br><a class="trace-frames" data-frame-id="9" href="#">activesupport (5.0.0.1) lib/active_support/tagged_logging.rb:26:in `tagged&#39;</a><br><a class="trace-frames" data-frame-id="10" href="#">activesupport (5.0.0.1) lib/active_support/tagged_logging.rb:70:in `tagged&#39;</a><br><a class="trace-frames" data-frame-id="11" href="#">railties (5.0.0.1) lib/rails/rack/logger.rb:24:in `call&#39;</a><br><a class="trace-frames" data-frame-id="12" href="#">sprockets-rails (3.2.0) lib/sprockets/rails/quiet_assets.rb:13:in `call&#39;</a><br><a class="trace-frames" data-frame-id="13" href="#">actionpack (5.0.0.1) lib/action_dispatch/middleware/request_id.rb:24:in `call&#39;</a><br><a class="trace-frames" data-frame-id="14" href="#">rack (2.0.1) lib/rack/method_override.rb:22:in `call&#39;</a><br><a class="trace-frames" data-frame-id="15" href="#">rack (2.0.1) lib/rack/runtime.rb:22:in `call&#39;</a><br><a class="trace-frames" data-frame-id="16" href="#">activesupport (5.0.0.1) lib/active_support/cache/strategy/local_cache_middleware.rb:28:in `call&#39;</a><br><a class="trace-frames" data-frame-id="17" href="#">actionpack (5.0.0.1) lib/action_dispatch/middleware/executor.rb:12:in `call&#39;</a><br><a class="trace-frames" data-frame-id="18" href="#">actionpack (5.0.0.1) lib/action_dispatch/middleware/static.rb:136:in `call&#39;</a><br><a class="trace-frames" data-frame-id="19" href="#">rack (2.0.1) lib/rack/sendfile.rb:111:in `call&#39;</a><br><a class="trace-frames" data-frame-id="20" href="#">railties (5.0.0.1) lib/rails/engine.rb:522:in `call&#39;</a><br><a class="trace-frames" data-frame-id="21" href="#">puma (3.6.0) lib/puma/configuration.rb:225:in `call&#39;</a><br><a class="trace-frames" data-frame-id="22" href="#">puma (3.6.0) lib/puma/server.rb:578:in `handle_request&#39;</a><br><a class="trace-frames" data-frame-id="23" href="#">puma (3.6.0) lib/puma/server.rb:415:in `process_client&#39;</a><br><a class="trace-frames" data-frame-id="24" href="#">puma (3.6.0) lib/puma/server.rb:275:in `block in run&#39;</a><br><a class="trace-frames" data-frame-id="25" href="#">puma (3.6.0) lib/puma/thread_pool.rb:116:in `call&#39;</a><br><a class="trace-frames" data-frame-id="26" href="#">puma (3.6.0) lib/puma/thread_pool.rb:116:in `block in spawn_thread&#39;</a><br></code></pre>
    </div>
...
<tr class='route_row' data-helper='path'>
  ...
  <td data-route-path='/sessions(.:format)'>
    /sessions(.:format)
  </td>
  <td>
    <p>sessions#create</p>
...
<tr class='route_row' data-helper='path'>
  <td data-route-name='teams'>
      teams<span class='helper'>_path</span>
  </td>
  <td>
    GET
  </td>
  <td data-route-path='/teams(.:format)'>
    /teams(.:format)
  </td>
  <td>
    <p>teams#index</p>
...
<tr class='route_row' data-helper='path'>
  <td data-route-name='new_teams'>
      new_teams<span class='helper'>_path</span>
  </td>
  <td>
    GET
  </td>
  <td data-route-path='/teams/new(.:format)'>
    /teams/new(.:format)
  </td>
  <td>
    <p>teams#new</p>
...
<tr class='route_row' data-helper='path'>
  <td data-route-name='team'>
      team<span class='helper'>_path</span>
  </td>
  <td>
    GET
  </td>
  <td data-route-path='/users/:user_id/teams/:team_id(.:format)'>
    /users/:user_id/teams/:team_id(.:format)
  </td>
  <td>
    <p>teams#show</p>
  </td>
...
<tr class='route_row' data-helper='path'>
  <td data-route-name='user_teams'>
      user_teams<span class='helper'>_path</span>
  </td>
  <td>
    GET
  </td>
  <td data-route-path='/users/:user_id/teams(.:format)'>
    /users/:user_id/teams(.:format)
  </td>
  <td>
    <p>team_users#index</p>
  </td>
</tr>
<tr class='route_row' data-helper='path'>
  <td data-route-name='team_users'>
      team_users<span class='helper'>_path</span>
  </td>
  <td>
    POST
  </td>
  <td data-route-path='/teams/:team_id/users(.:format)'>
    /teams/:team_id/users(.:format)
  </td>
  <td>
    <p>team_users#create</p>
  </td>
</tr>
<tr class='route_row' data-helper='path'>
  <td data-route-name='users_in_a_team'>
      users_in_a_team<span class='helper'>_path</span>
  </td>
  <td>
    GET
  </td>
  <td data-route-path='/teams/:team_id/users/show(.:format)'>
    /teams/:team_id/users/show(.:format)
  </td>
  <td>
    <p>teams#show</p>
  </td>
...
<tr class='route_row' data-helper='path'>
  <td data-route-name='user_logs'>
      user_logs<span class='helper'>_path</span>
  </td>
  <td>
    GET
  </td>
  <td data-route-path='/users/:user_id/logs(.:format)'>
    /users/:user_id/logs(.:format)
  </td>
  <td>
    <p>logs#index</p>
  </td>
...
<tr class='route_row' data-helper='path'>
  <td data-route-name='new_log'>
      new_log<span class='helper'>_path</span>
  </td>
  <td>
    GET
  </td>
  <td data-route-path='/users/:user_id/logs/new(.:format)'>
    /users/:user_id/logs/new(.:format)
  </td>
  <td>
    <p>logs#new</p>
  </td>
...
<tr class='route_row' data-helper='path'>
  ...
  <td data-route-path='/users/:user_id(.:format)'>
...
<tr class='route_row' data-helper='path'>
  <td data-route-name='log'>
      log<span class='helper'>_path</span>
  </td>
  <td>
    GET
  </td>
  <td data-route-path='/users/:user_id/logs/:log_id(.:format)'>
    /users/:user_id/logs/:log_id(.:format)
  </td>
  <td>
    <p>logs#show</p>
  </td>
...
<tr class='route_row' data-helper='path'>
  <td data-route-name='edit_log'>
      edit_log<span class='helper'>_path</span>
  </td>
  <td>
    GET
  </td>
  <td data-route-path='/users/:user_id/logs/:log_id/edit(.:format)'>
    /users/:user_id/logs/:log_id/edit(.:format)
  </td>
  <td>
    <p>logs#edit</p>
  </td>
...
<div class="details">
  ...
  <div id="session_dump" style="display:none"><pre>_csrf_token: &quot;ubXRAIja8Gd0lnCv2DoBlHbSx+v6T3rA/JxyPATvVHM=&quot;
session_id: &quot;dc8779d955a890c5c9963df6c5f1117a&quot;
user_id: 1</pre></div>
</div>
...
<div id="console"
  ...
  data-session-id='7d2acabdaf4c77a83d7cc608a62bb2a5'
  data-prompt-label='>> '>
</div>
